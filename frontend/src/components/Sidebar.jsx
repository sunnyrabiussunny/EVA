...
import {
  ...
  Lightbulb, Newspaper, BookOpen, Settings, Sun, Moon,
  Power, MessageSquare, TrendingUp, Target, Layers,
  FolderSearch, BarChart2
} from 'lucide-react';
        ...
        <button onClick={toggleAI} disabled={toggling} style={{
          ...
          <div style={{ flex:1, textAlign:'left' }}>
            ...
            <div style={{ fontSize:10, color:'var(--text3)', marginTop:1 }}>
              {aiRunning ? 'Click to stop background tasks' : 'Click to resume'}
            </div>
          </div>
          <div style={{
